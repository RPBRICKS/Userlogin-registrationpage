...
function UserRegisterForm({ setIsAuthenticated }) {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3001/register', { username, email, password, usertype })
            .then(result => {
                toast.success("Account is awaiting approval");
                navigate("/login");
            })
            .catch(err => {
